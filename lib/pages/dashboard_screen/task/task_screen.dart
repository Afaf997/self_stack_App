...
//               context,
//               MaterialPageRoute(
//                 builder: (context) => DetailOfTask(taskId: state.taskId, courseId: state.courseId),
//               ),
//             );
//           }
//         },
...
//                   valueColor: AlwaysStoppedAnimation<Color>(kwhiteModel),
//                 ),
//               ),
//             );
//           } else if (state is TaskLoadedState) {
//             Map<String, dynamic> userDetails = state.userDetails;
...
//                                   );
//                                 } else {
//                                   context.read<TaskBloc>().add(NavigateToDetailEvent(taskId: taskId, courseId: courseId));
//                                 }
//                               },
//                               child: Padding(
