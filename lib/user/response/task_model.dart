...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic>? json) {
    ...
    return UserData(
      ...
      tasksStarted: List<TasksStarted>.from(
          json["tasksStarted"]?.map((x) => TasksStarted.fromJson(x)) ?? []),
      tasksCompleted: List<dynamic>.from(json["tasksCompleted"] ?? []),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tasksStarted":
            List<dynamic>.from(tasksStarted.map((x) => x.toJson())),
...
class TasksStarted {
  ...
  factory TasksStarted.fromRawJson(String str) =>
      TasksStarted.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TasksStarted.fromJson(Map<String, dynamic>? json) {
    if (json == null) {
      throw ArgumentError('json must not be null');
    }
    return TasksStarted(
...
class UserTask {
  ...
  factory UserTask.fromRawJson(String str) =>
      UserTask.fromJson(json.decode(str));
